...
def get_filters():
    ...
    while True:
        try:
            month = input('If you want to filter the data by a month, enter the month\'s name or else enter \'all\': ').lower()
            break
        except ValueError:
            print('Not a valid input. Try one more time.')
    ...
    while True:
        try:
            day = input('If you want to filter the data by a day, enter the day\'s name or else enter \'all\': ').lower()
            break
        except ValueError:
            print('Not a valid input. Try one more time.')
...
def time_stats(df):
    ...
    m=df['month'].mode()[0]
    months = ['january', 'february', 'march', 'april', 'may', 'june']
    print('\nThe most common month is ',months[m].title())
...
def station_stats(df):
    ...
    print('\nThe most frequent combo of start and end station trip: ',(df['Start Station'] + df['End Station']).mode()[0])
...
def trip_duration_stats(df):
    ...
    print('\nThe average travel time: ',df['Trip Duration'].mean())
